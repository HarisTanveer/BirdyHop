...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    private Button btnSignup, btnLogin, btnReset, btnGoogle, guestLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Use this code to get key for facebook
//        try {
//            PackageInfo info =     getPackageManager().getPackageInfo("com.example.ga.flappybird", PackageManager.GET_SIGNATURES);
...
//        }
        ...
        SignInButton sbt = findViewById(R.id.sign_in_button);
        setGooglePlusButtonText(sbt, "Sign in with Google");

        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("319406669982-hc6nkpbgg7jdbe2ganbi8l2spajvocne.apps.googleusercontent.com")
                .requestEmail()
                .build();
